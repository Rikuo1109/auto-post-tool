...
class ZaloService(object):
    ...
    def request_access_oath(self, oath_code: str):
        return self.get_response(data={"app_id": self.app_id, "grant_type": "authorization_code", "code": oath_code})

    def request_access_fefresh(self, refresh_token: str):
        return self.get_response(data={"app_id": self.app_id, "grant_type": "refresh_token", "code": refresh_token})
