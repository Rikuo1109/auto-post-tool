...
FIREBASE_APIKEY = str(os.environ.get("FIREBASE_APIKEY"))
FIREBASE_AUTHDOMAIN = str(os.environ.get("FIREBASE_AUTHDOMAIN"))
FIREBASE_DATABASEURL = str(os.environ.get("FIREBASE_DATABASEURL"))
FIREBASE_PROJECTID = str(os.environ.get("FIREBASE_PROJECTID"))
FIREBASE_STORAGEBUCKET = str(os.environ.get("FIREBASE_STORAGEBUCKET"))
FIREBASE_MESSAGINGSENDERID = str(os.environ.get("FIREBASE_MESSAGINGSENDERID"))
FIREBASE_APPID = str(os.environ.get("FIREBASE_APPID"))
FIREBASE_MEASUREMENTID = str(os.environ.get("FIREBASE_MEASUREMENTID"))
